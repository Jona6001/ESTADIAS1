        ...
        <section className="home-left">
          ...
          <div className="home-actions-grid">
            ...
            >
              ...
              <div className="home-card-text">
                <h3>Ventas</h3>
                <p>{stats.cotizaciones} cotizaciones</p>
              </div>
            </button>
            <button
              className="home-card home-card-action inventory-card"
            ...
            >
              ...
              <div className="home-card-text">
                <h3>Clientes</h3>
                <p>{stats.clientes} registrados</p>
              </div>
            </button>
            <button
              className="home-card home-card-action inventory-card"
          ...
          <div className="card kpi-row" style={{ marginTop: 8 }}>
            ...
            <div className="kpi" title="Pendientes">
              ...
              <span className="kpi-value kpi-pendiente">
                {stats.pendientes}
              </span>
            </div>
            ...
            <div className="kpi" title="Canceladas">
              ...
              <span className="kpi-value kpi-cancelado">
                {stats.canceladas}
              </span>
            </div>
            ...
            <div className="kpi" title="Monto total de cotizaciones">
              ...
              <span className="kpi-value">
                $
                {stats.montoTotal.toLocaleString("es-MX", {
                ...
                {recentSales.map((s) => {
                  ...
                  return (
                    <li key={s.id} className="sale-item">
                      ...
                      <span className="col-cliente">
                        {s.cliente || s.Cliente?.nombre || "—"}
                      </span>
                      <span className="col-total">
                        $
                        {Number(s.total || s.subtotal || 0).toLocaleString(
                          "es-MX",
                          { minimumFractionDigits: 2 }
                        )}
                      </span>
                      <span className="col-fecha">
                        {new Date(
                          s.fecha_creacion || s.fecha || Date.now()
