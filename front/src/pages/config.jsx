  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const body = {
        ...
        ...(showPasswordFields && form.contrasena
          ? { contrasena: form.contrasena }
          : {}),
      };
      const res = await fetch(
        `https://estadias1-backend-production.up.railway.app/usuarios/${user.ID}`,
        {
          method: "PATCH",
          headers: {
        ...
        <div className="nav-container">
          <div className="nav-left">
            ...
            <header className="header">
              <h1>
                CONFIGURACIÓN <FaUserCog className="iconName" />
              </h1>
            </header>
          ...
          <form className="config-form" onSubmit={handleSubmit}>
            ...
            {successMsg && (
              <div className="success-msg">
                <FaCheckCircle
                  style={{ color: "#1a7f37", marginRight: 6, marginBottom: -2 }}
                />
                {successMsg}
              </div>
            )}
